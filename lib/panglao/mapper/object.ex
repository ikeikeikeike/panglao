defmodule Panglao.Mapper.Object do
  ...
  def link(conn, %{object: o}) do
    %{
      ...
      embed: if(o.src, do: page_url(conn, :embed, o, URI.encode(o.src.file_name)), else: error_url(conn, :unavailable)),
      short: if(o.src, do: page_url(conn, :short, o, o.slug), else: error_url(conn, :unavailable)),
      direct: if(o.src, do: page_url(conn, :direct, o, URI.encode(o.src.file_name)), else: error_url(conn, :unavailable)),
